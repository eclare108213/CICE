...
.. csv-table:: **CPP Macros**
   ...
   "NO_MPI", "Turns off all MPI parallel coding reverting to serial mode."
...
.. csv-table:: **CICE settings**
   ...
   "ICE_COMMDIR", "mpi, serial", "specifies whether to support MPI or just serial capabilities", "set by ICE_NTASKS"
...
.. csv-table:: **domain_nml namelist options**
   ...
   "", "``linear_extrap``", "constant gradient Neumann boundary condition in x based on near interior values", ""
   "", "``open``", "no boundary condition applied in x, potential use with restoring", ""
   "", "``zero_gradient``", "zero gradient Neumann boundary conditions in x based on near interior values", ""
   ...
   "", "``linear_extrap``", "constant gradient Neumann boundary condition in y based on near interior values", ""
   "", "``open``", "no boundary condition applied in y, potential use with restoring", ""
   "", "``tripole``", "U-fold tripole boundary conditions in y at north boundary, closed boundary condition at south boundary", ""
   "", "``tripoleT``", "T-fold tripole boundary conditions in y at north boundary, closed boundary condition at south boundary", ""
   "", "``zero_gradient``", "zero gradient Neumann boundary conditions in y based on near interior values", ""
   ...
   "``set_boundary_flds``", "", "array of strings specifying exterior boundary fields restoring", ""
   "", "``aicen``", "restore ice concentration in all categories", ""
   "", "``none``", "do not restore, same as blank", ""
...
.. csv-table:: **forcing_nml namelist options**
   ...
   "``restore_flds``", "", "array of strings specifying interior fields restoring", ""
   "", "``aicen``", "restore ice concentration in all categories", ""
   "", "``none``", "do not restore, same as blank", ""
   "", "``state``", "restore aicen, vicen, vsnon, and trcrn", ""
   "", "``trcrn``", "restore all tracers in all categories", ""
   ...
   "", "``none``", "at no interior gridpoints", ""
   "``restore_timescale``", "real", "interior restoring timescale in days", "0"
   "``restore_width``", "integer", "interior sponge layer width in gridcells from outside boundary", "0"
...
.. csv-table:: **zbgc_nml namelist options**
   ...
   "``restore_bgc``", "logical", "restore bgc to data, DEPRECATED", "``.false.``"
